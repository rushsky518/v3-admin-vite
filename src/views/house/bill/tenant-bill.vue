...
const handleUpdate = (row: GetBillData) => {
  ...
  formData.actualPledge = row.actualPledge
  ...
  <div class="app-container">
    ...
    >
      <el-form ref="formRef" :model="formData" :rules="formRules" label-width="100px" label-position="left">
        ...
        <el-form-item prop="roomSize" label="房间面积" >
          <el-input v-model="formData.roomSize" placeholder="请输入" readonly="true" />
        </el-form-item>
        <el-form-item prop="originalRent" label="应付押金">
          <el-input v-model="formData.originalPledge" placeholder="请输入" readonly="true" />
        </el-form-item>
        <el-form-item prop="actualRent" label="实付押金">
          <el-input v-model="formData.actualPledge"  placeholder="请输入" />
        </el-form-item>
